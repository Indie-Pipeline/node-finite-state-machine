...
const UpdateNotifyToolScene: PackedScene = preload("updater/update_notify_tool.tscn")
...
func _enter_tree() -> void:
	...
	add_custom_type("FiniteStateMachine", "Node", preload("src/machine_state.gd"), preload("assets/fsm.png"))
